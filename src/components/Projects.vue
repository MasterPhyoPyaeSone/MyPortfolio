      ...
      projects: [
        {
          ...
          description: 'A full-stack e-commerce solution with modern UI, shopping cart, payment integration, and admin dashboard. Built with Vue.js and Node.js.',
...
.projects::before {
  ...
  right: 0;
  bottom: 0;
  background: radial-gradient(circle at 20% 80%, rgba(102, 126, 234, 0.05) 0%, transparent 70%);
  pointer-events: none;
}
